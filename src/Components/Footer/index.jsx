const Footer = () => {
  return (
    <footer className="footer">
      ...
      <div className="h4 title text-center">Kylie Makarages</div>
      <div className="text-center text-muted">
        <p>© MID-FE. All rights reserved.<br />Design - <a className="credit" href="https://templateflip.com" target="_blank" rel="noreferrer">Kylie Makarages</a></p>
      </div>
    </footer>
  )
}
