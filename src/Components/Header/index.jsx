const Header = () => {
  return (
    <header>
      <div className="profile-page sidebar-collapse bgheader">
        <nav className="navbar navbar-expand-lg fixed-top navbar-transparent bg-primary bgheader">
          <div className="container bgheader">
            <div className="navbar-translate"><a className="navbar-brand" href="#" rel="tooltip">MID Front-End</a>
